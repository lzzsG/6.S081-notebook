...
permalink: /L06-Isolation-System-Call-EntryExit/
description: "L06 Isolation & System Call Entry/Exit. 了解用户空间与内核空间切换的核心机制，剖析程序在系统调用、异常处理和设备中断中的切换过程。掌握操作系统中陷入（trap）机制的原理，为系统安全性与性能优化奠定基础。"
nav_order: 6
