...
permalink: /L17
description: "Lecture 17 - Virtual Memory for Applications，本节内容主要是讨论用户应用程序使用虚拟内存所需的特性，并以1991年的一篇[论文](https://pdos.csail.mit.edu/6.828/2020/readings/appel-li.pdf)为背景，讨论了这些特性对应用程序的重要性。"
nav_order: 17
